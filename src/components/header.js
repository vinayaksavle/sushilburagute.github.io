    ...
    return (
      <Div article={this.props.article}>
        <LogoWrapper article={this.props.article}>
          ...
          {!this.props.article && (
            <Name article={this.props.article}>Sushil Buragute</Name>
          )}
          {!this.props.article && <Role>UI / UX Design | Web Dev</Role>}
        </LogoWrapper>
        <div>
          <SocialLinks article={this.props.article}>
            <SocialLink
              ...
              aria-label="Send an email to Sushil"
            >
              <SvgWrapper>
                <InlineSvg>
            ...
            <SocialLink
              ...
              onMouseLeave={this.hideTooltip}
              onBlur={this.hideTooltip}
              aria-label="Sushil's twitter profile"
            >
              <SvgWrapper>
                <InlineSvg>
            ...
            <SocialLink
              href="https://www.instagram.com/sushil.buragute"
              target="blank"
              onMouseOver={() => this.showTooltip("Instagram")}
              onFocus={() => this.showTooltip("Instagram")}
              onMouseLeave={this.hideTooltip}
              onBlur={this.hideTooltip}
              aria-label="Sushil's instagram profile"
            >
              <SvgWrapper>
                <InlineSvg>
